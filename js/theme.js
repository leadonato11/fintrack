...
const DIAS_ESPECIALES = [
  ...
  },
  {
    ...
    clase: "special-solemne",
    emoji: "🇦🇷",
    nombre: "Día de Malvinas",
  },
  {
    mes: 5,
    dia: 1,
    clase: "special-patria",
    emoji: "✊",
  ...
  },
  {
    mes: 8,
    dia: 12,
    clase: "special-cumple",
    emoji: "🎂",
    nombre: "¡Feliz cumple, Lea! 🎉",
  },
  {
    mes: 8,
    dia: 17,
  ...
  },
  {
    mes: 12,
    dia: 31,
    clase: "special-newyear2",
    emoji: "🥂",
    nombre: "¡Feliz Fin de Año!",
  },
];
...
export function applyTheme(mode) {
  ...
  const esDark =
    mode === "dark" || (mode === "auto" && (hora >= 20 || hora < 7));
